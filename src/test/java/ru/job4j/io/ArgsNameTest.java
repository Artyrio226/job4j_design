...
class ArgsNameTest {
    ...
    @Test
    void whenStringDoesNotContainKeyThenException() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx=512", "-=secret="}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '-=secret=' does not contain a key");
    }

    @Test
    void whenStringDoesNotContainValueThenException() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx=512", "-code3="}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '-code3=' does not contain a value");
    }

    @Test
    void whenThereNoEqualSignThenException() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx512", "-request?=secret"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
    ...
    @Test
    void whenNoHyphenPrefixThenException() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx=512", "=secret="}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '=secret=' does not start with a '-' character");
    }
}
...
class SimpleMapTest {
    ...
    @Test
    void whenCheckSomePut() {
        assertThat(map.put(0, "0")).isTrue();
        assertThat(map).hasSize(5);
        assertThat(map.put(8, "8")).isFalse();
        assertThat(map).hasSize(5);
        assertThat(map.put(10, "10")).isFalse();
        assertThat(map.put(3, "10")).isFalse();
        assertThat(map).hasSize(5)
    ...
    void whenGetSomeKey() {
        ...
        assertThat(map.put(7, "10")).isFalse();
